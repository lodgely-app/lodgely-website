...
export default function AboutUs() {
  return (
    <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
      <SEO 
        title="About Us" 
        description="Learn more about Lodgely and our mission to elevate property management and tenant living." 
        canonicalUrl="https://lodgely.ng/about"
      />
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          <h1 className="text-4xl md:text-6xl font-light tracking-tight text-slate-900 mb-6">
            Our Mission is to <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-cyan-500 font-medium">Elevate Living</span>
          </h1>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-light tracking-tight text-slate-900">Our Core Values</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-medium text-slate-900 mb-3">Simplicity First</h3>
            ...
            <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-medium text-slate-900 mb-3">Lightning Fast</h3>
              <p className="text-slate-500 font-light leading-relaxed">
            ...
            <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-medium text-slate-900 mb-3">Absolute Security</h3>
              <p className="text-slate-500 font-light leading-relaxed">
            ...
            <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-medium text-slate-900 mb-3">Empathetic Support</h3>
              <p className="text-slate-500 font-light leading-relaxed">
        ...
        <div className="bg-slate-900 rounded-[2.5rem] p-8 md:p-16 text-white text-center">
          <h2 className="text-3xl md:text-4xl font-light tracking-tight mb-6">The Lodgely Story</h2>
